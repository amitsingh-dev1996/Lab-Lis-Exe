...
{
    public partial class VSoftLISLogin : Form
    {
        private string userCode_Temp = "";

        public VSoftLISLogin()
        {
            InitializeComponent();
        }
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            loginAPIResult = WebAPICommon.PostApi(WebAPI.VSoftLisApiBaseUrl, "AccountAPI/Login", loginUser, loginAPIResult, TimeoutMilliSeconds: 30 * 1000) as LoginAPIResult;
            ...
            {
                MessageBox.Show("You do not have access to configure LIS. Kindly get it assigned from Vsoft Web portal.");
                return;
            }
    ...
    public class LoginUser
    {
        ...
        public string Domain { get { return "VSoftLis"; } }
    }
